...
MixStream is a modern, media streaming client. It draws inspiration from the versatile architecture of CloudStream but implements a custom, cross-platform JavaScript engine for extensions, enabling support for Android, iOS, and Desktop from a single codebase.
...
💡 **MixStream** is designed as a **scalable, plugin-driven, cross-platform streaming platform**—delivering flexibility, performance, and a seamless viewing experience across all devices.
...
Download the latest version from the **[Releases Page](https://github.com/alwayszihanx/MixStream/releases/latest)**.

### 🤖 Android / Android TV
1. Download the `mixstream-android-arm64-v8a-v2.5.0.apk` (recommended for most modern phones) or `mixstream-android-armeabi-v7a-v2.5.0.apk` (for TV) from Releases.
2. Open the file and tap **Install**.
   - *Note: You may need to allow "Install from Unknown Sources" in your browser settings.*
3. Open MixStream and install extensions via **Settings > Extensions**.

### 🍏 iOS (Sideloading)
MixStream is not on the App Store. You must **sideload** it using a computer.
...
**Steps:**
1. Download `mixstream-ios-unsigned-v2.5.0.ipa` from the [Releases Page](https://github.com/alwayszihanx/MixStream/releases/latest).
...
### 💻 Windows / macOS / Linux
1. Download the appropriate file for your OS (`mixstream-windows.exe`, `mixstream-macos.dmg`, `mixstream-linux.deb`, etc.).
2. Install the app.
...
- **Found a bug?** Report it on our **[GitHub Issues](https://github.com/alwayszihanx/MixStream/issues)** page.
- **Want to translate?** See our **[Translation Guide](docs/CONTRIBUTING_TRANSLATIONS.md)**.
- **Want to build a plugin?** Check the **[Extension Guide](https://github.com/alwayszihanx/Mixplug/blob/main/DEVELOPER.md)**.
...
MixStream uses `.sky` or `.js` extension files. You can install them by navigating to <b>Settings > Extensions > Add Repository</b> and entering a repository URL (e.g., using a shortcode).
</details>

<details>
<summary><b>Where is the media stored?</b></summary>
MixStream is a streaming client and does not host any content. All media is streamed directly from the third-party extensions you install.
</details>
...
<a href="https://www.star-history.com/#alwayszihanx/MixStream&Date">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=alwayszihanx/MixStream&type=date&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=alwayszihanx/MixStream&type=Date" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=alwayszihanx/MixStream&type=Date" />
 </picture>
</a>
...
<a href="https://github.com/alwayszihanx/MixStream/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=alwayszihanx/MixStream" />
</a>
