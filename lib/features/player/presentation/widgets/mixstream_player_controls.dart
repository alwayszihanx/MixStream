...
class MixStreamPlayerControls extends ConsumerStatefulWidget {
  final Player player;
  ...
  @override
  ConsumerState<MixStreamPlayerControls> createState() =>
      MixStreamPlayerControlsState();
}

class MixStreamPlayerControlsState
    extends ConsumerState<MixStreamPlayerControls>
  ...
  @override
  void didUpdateWidget(MixStreamPlayerControls oldWidget) {
  ...
  Future<void> _handleDoubleTap() async {
    ...
    try {
      ...
      if (kDebugMode) {
        debugPrint('MixStreamPlayerControls._handleDoubleTap: $e');
      }
    }
  ...
  void cycleResize() {
    setState(() {
      ...
      ref
          .read(playerGestureHandlerProvider.notifier)
          .showToast(labels[_resizeMode], 'aspect_ratio');
    });
  }
  ...
  Widget _buildUnlockedUI({
    ...
    final actions = <Widget>[
      ...
      if (isDesktop)
        PlayerIconButton(
          icon: AppIcon(_isFullscreen ? 'fullscreen_exit_rounded' : 'fullscreen_rounded'),
