...
class MixStreamSubtitleView extends ConsumerStatefulWidget {
  final Player player;
  final vv.VideoController? videoViewController;
  final bool useExoPlayer;
  final bool controlsVisible;

  const MixStreamSubtitleView({
    super.key,
  ...
  @override
  ConsumerState<MixStreamSubtitleView> createState() =>
      _MixStreamSubtitleViewState();
}

class _MixStreamSubtitleViewState extends ConsumerState<MixStreamSubtitleView> {
  ...
  @override
  void didUpdateWidget(covariant MixStreamSubtitleView oldWidget) {
