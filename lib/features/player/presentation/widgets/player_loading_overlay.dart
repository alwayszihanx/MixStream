              ...
              child: Container(
                ...
                child: CustomButton(
                  ...
                  child: const Padding(
                    ...
                    child: AppIcon('arrow_back', color: Colors.white, size: 34),
                  ),
                ),
              ),
            ),
  ...
  (Widget?, Color, String) _statusPresentation(
    ...
    switch (status) {
      ...
      case SourceAttemptStatus.selected:
        return (
          const AppIcon('radio_button_checked', size: 16, color: Colors.white),
          Colors.white,
          l10n.selected,
        );
      case SourceAttemptStatus.playing:
        return (
          const AppIcon('check_circle', size: 16, color: Colors.green),
